...
var _animal = __webpack_require__(128);

var _animal2 = _interopRequireDefault(_animal);

var _calculator = __webpack_require__(85);
...
// let stringInclude = "Hey bud!".includes("ey");
// console.log(stringInclude);

// let arrayInclude = [1,2,3,4,5].includes(3);
...
/*
	These features are proposal of the es8.
	Not officially declacred. May be included 
	in next version i.e. es8
*/
...
var _marked = [arrayIterator].map(regeneratorRuntime.mark);
...
function arrayIterator() {
  var _args = arguments;
  return regeneratorRuntime.wrap(function arrayIterator$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.delegateYield(_args, "t0", 1);
...
// const rootApi = "https://jsonplaceholder.typicode.com/posts";

// fetch(rootApi, { method: "GET"})
// .then(response => response.json())
// .then(jsonData => console.log(jsonData))
// .catch(error => console.log("Please check url"));
...
var p = new Promise(function (resolveData, rejected) {
	setTimeout(function () {
